...
local function set_wallpaper(s)
  ...
  if beautiful.wallpaper then
    ...
    gears.wallpaper.maximized("/home/iam/Pictures/wp3556723.jpg", s, true)
  end
end
...
globalkeys = gears.table.join(
  ...
  awful.key({}, "XF86AudioMute", function() awful.spawn.with_shell("amixer -c 1 set Master toggle") end),
